...
export const InventoryView = {
  ...
  bindUniformCardEvents(container) {
    ...
    container.querySelectorAll(".action-btn.import").forEach((btn) => {
      btn.addEventListener("click", () => {
        const id = btn.dataset.id;
        console.log("📥 Dispatch importCodeClick:", id); // ✅ Debug log
        window.dispatchEvent(new CustomEvent("importCodeClick", { detail: { id } }));
      });
    });
  },  
